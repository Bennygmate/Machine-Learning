...
neurons::NN_layer::NN_layer(lint threads) : m_ops{ static_cast<size_t>(threads) } {}

neurons::NN_layer::NN_layer(const NN_layer & other) : m_ops{ static_cast<size_t>(other.m_ops.size()) } {}

neurons::NN_layer::NN_layer(NN_layer && other) : m_ops{ static_cast<size_t>(other.m_ops.size()) } {}
...
neurons::NN_layer_op::NN_layer_op() : m_loss {0} {}

neurons::NN_layer_op::NN_layer_op(const NN_layer_op & other) : m_loss{ other.m_loss } {}

neurons::NN_layer_op::NN_layer_op(NN_layer_op && other) : m_loss{ std::move(other.m_loss) } {}
